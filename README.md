...
our [releases](https://github.com/SeleniumHQ/docker-selenium/releases/tag/4.48.0-20260905).
...
``` bash
$ docker run -d -p 4444:4444 -e SE_OPTS="--log-level FINE" --name selenium-hub selenium/hub:4.48.0-20260905
```
...
``` bash
$ docker run -d -p 4444:4444 -e SE_JAVA_OPTS=-Xmx512m --name selenium-hub selenium/hub:4.48.0-20260905
```
...
$ docker run -d \
  ...
  --shm-size="2g" selenium/node-chrome:4.48.0-20260905
```
...
```bash
$ docker run -d -p 4444:4444 -e SE_SUB_PATH=/selenium-grid/ --name selenium-hub selenium/hub:4.48.0-20260905
```
...
``` bash
docker run -d -e SE_SCREEN_WIDTH=1366 -e SE_SCREEN_HEIGHT=768 -e SE_SCREEN_DEPTH=24 -e SE_SCREEN_DPI=74 selenium/standalone-firefox:4.48.0-20260905
```
...
``` bash
$ docker run -d --net grid -e SE_EVENT_BUS_HOST=selenium-hub \
  -e SE_START_XVFB=false --shm-size="2g" selenium/node-chrome:4.48.0-20260905
```
...
``` bash
$ docker run -e SE_DRAIN_AFTER_SESSION_COUNT=5 --shm-size="2g" selenium/standalone-firefox:4.48.0-20260905
```
...
``` bash
$ docker run -e SE_ENABLE_BROWSER_LEFTOVERS_CLEANUP=true --shm-size="2g" selenium/node-chrome:4.48.0-20260905
```
...
# Start from Selenium image and add relevant files from build image
FROM selenium/node-firefox:4.48.0-20260905
USER root
...
``` bash
$ docker run -d -p 4444:4444 -p 5900:5900 --shm-size="2g" selenium/standalone-chrome:4.48.0-20260905
$ docker run -d -p 4445:4444 -p 5901:5900 --shm-size="2g" selenium/standalone-edge:4.48.0-20260905
$ docker run -d -p 4446:4444 -p 5902:5900 --shm-size="2g" selenium/standalone-firefox:4.48.0-20260905
```
...
Here is an example with the standalone images, the same concept applies to the node images.
``` bash
$ docker run -d -p 4444:4444 -p 7900:7900 --shm-size="2g" selenium/standalone-chrome:4.48.0-20260905
$ docker run -d -p 4445:4444 -p 7901:7900 --shm-size="2g" selenium/standalone-edge:4.48.0-20260905
$ docker run -d -p 4446:4444 -p 7902:7900 --shm-size="2g" selenium/standalone-firefox:4.48.0-20260905
```
